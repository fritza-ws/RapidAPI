...
final class AgencyTests: XCTestCase {
    ...
    func testRawValues() {
        ...
        XCTAssertEqual(cta.rawValue, 2,
                       ".cta should have rawValue == 2"
        )
        XCTAssertEqual(uChicago.rawValue, 1,
                       ".uChicago should have rawValue == 1"
        )
    ...
    func testInitialization() {
        let agencyAndValue = zip(eachCase, [1,2,3,0])
